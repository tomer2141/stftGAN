...
from mapper import Mapper, MapperBoxMuller
import torch
import pickle
import io
from utils import csv2dic, CPU_Unpickler, compute_gp_mapper, compute_gp, weights_init
...
# weights_best_geneerator_path = 'checkpoints/new_data/rel/164000.pkl'
weights_best_geneerator_path = 'checkpoints/200500.pkl'
print(weights_best_geneerator_path)

# spectrograms_path = 'data/logspec_tal_new.pt'
...
for epoch in range(epochs):
    ...
    for idx, (hot1, hot2, hot3, hot4, hot5, hot6, hot7, specs) in enumerate(train_loader, 0):
        ...
        if idx % 100 == 0:
            torch.save(netM.state_dict(), "checkpoints/mapper_new_data/%d_%d" % (epoch, idx))
