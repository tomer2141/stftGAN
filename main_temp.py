...
real_imgs = torch.load('data/logspec_tal_tensor.pt')
    ...
    for i, data in enumerate(dataloader, 0):
        ...
        if i % cfg.n_critic == 0:
            ...
            if batches_done % (10 * cfg.n_critic) == 0:
                ...
                PIL_image.save('images/temp/%d.png' % batches_done)
            ...
            if batches_done % (100 * cfg.n_critic) == 0:
                ...
                with open('checkpoints/temp/%d.pkl' % batches_done, 'wb') as handle:
